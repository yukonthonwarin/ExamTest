        ...
        >
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div
                    ...
                    "
                >
                    <h1 style="font-size: 40px">Calculator</h1>
                    ...
                    <form action="" name="clc">
                        <input
                            ...
                            "
                        /><br />
                        <div class="max-w-7xl mx-auto p-6 lg:p-7"></div>
                        <input
                            class="btn"
                            type="button"
                            value="0"
                            onclick="clc.display.value += '0'"
                        />
                        <input
                            class="btn"
                            type="button"
                            value="1"
                            onclick="clc.display.value += '1'"
                        />
                        <input
                            class="btn"
                            type="button"
                            value="2"
                            onclick="clc.display.value += '2'"
                        />
                        <input
                            class="btn"
                            type="button"
                            value="+"
                            onclick="clc.display.value += '+'"
                            style="background-color: #cc5c11"
                        /><br />
                        <input
                            class="btn"
                            type="button"
                            value="3"
                            onclick="clc.display.value += '3'"
                        />
                        <input
                            class="btn"
                            type="button"
                            value="4"
                            onclick="clc.display.value += '4'"
                        />
                        <input
                            class="btn"
                            type="button"
                            value="5"
                            onclick="clc.display.value += '5'"
                        />
                        <input
                            class="btn"
                            type="button"
                        ...
                        <input
                            ...
                            type="button"
                            value="6"
                            onclick="clc.display.value += '6'"
                        />
                        <input
                            class="btn"
                            type="button"
                            value="7"
                            onclick="clc.display.value += '7'"
                        />
                        <input
                            class="btn"
                            type="button"
                            value="8"
                            onclick="clc.display.value += '8'"
                        />
                        <input
                            class="btn"
                            type="button"
                        ...
                        <input
                            ...
                            type="button"
                            value="="
                            onclick="clc.display.value =eval(clc.display.value)"
                            style="background-color: #1f80c9"
                        />
                        <input
                            class="btn"
                            type="button"
